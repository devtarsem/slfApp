...
function Menu(){
    return(
        <div className='menu pad16 flex flex-1'>
            <Link to='home' className='menuLink flex flex-2 flex-dir gap4'>
            ...
            <Link to='explore' className='menuLink flex flex-2 flex-dir gap4'>
